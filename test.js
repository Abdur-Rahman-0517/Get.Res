...
div.dispatchEvent(new MouseEvent("mousedown",{clientX:cx+r,clientY:cy,bubbles:true,cancelable:true})); \
const points=120; \
for(let i=0;i<=points;i++){ \
const angle=i/points*Math.PI*2; \
const x=Math.round(cx+r*Math.cos(angle)); \
const y=Math.round(cy+r*Math.sin(angle)); \
div.dispatchEvent(new MouseEvent("mousemove",{clientX:x,clientY:y,bubbles:true,cancelable:true})) \
} \
